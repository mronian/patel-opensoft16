...
Input = [[("Page1_plot1","X-Axis","Y-Axis",[("Caption2",[(10,20),(30,40)]),("Caption3",[(10,20),(30,40)])]),("Page1_plot2","X-Axis","Y-Axis",[("Caption2",[(10,20),(30,40)]),("Caption3",[(10,20),(30,40)])])],[("Page2_plot1","X-Axis","Y-Axis",[("Caption2",[(10,20),(30,40)]),("Caption3",[(10,20),(30,40)])]),("Page2_plot2","X-Axis","Y-Axis",[("Caption2",[(10,20),(30,40)]),("Caption3",[(10,20),(30,40)])])]]
doc = SimpleDocTemplate("test.pdf", pagesize=letter, rightMargin=30,leftMargin=30, topMargin=30,bottomMargin=18)
elements = []
for page in Input:
         elements.append(Image("page1.png"))
         for plot in page:
             Plot_Caption = plot[0]
             x_caption = plot[1]
             y_caption = plot[2]
